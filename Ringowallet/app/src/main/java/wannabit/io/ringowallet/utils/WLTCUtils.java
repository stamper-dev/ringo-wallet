...
public class WLTCUtils {
    ...
    public WLTCUtils() {
        this.mParams  = LitecoinMainNetParams.get();
    }

    public WLTCUtils(String seed) {
        try {
    ...
    public List<ChildNumber> getParentPath() {
        return  ImmutableList.of(new ChildNumber(44, true), new ChildNumber(2, true), ChildNumber.ZERO_HARDENED, ChildNumber.ZERO);
    }
