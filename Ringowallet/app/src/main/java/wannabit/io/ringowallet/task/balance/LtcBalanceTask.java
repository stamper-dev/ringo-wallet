...
public class LtcBalanceTask extends BalanceCheckByKeyTask {
    private BaseApplication     mApp;
    private TaskCallback        mCallback;
    private TaskResult          mResult;
    private ArrayList<Key>      mKeys;

    public LtcBalanceTask(BaseApplication app, TaskCallback mCallback, ArrayList<Key> keys) {
        this.mApp       = app;
    ...
    protected TaskResult doInBackground(Bundle... bundles) {
        try {
            ...
            WLog.w("LtcBalanceTask Exception : "  + e.getMessage());
