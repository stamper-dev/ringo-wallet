...
public final class WBTCUtils {
    ...
    public WBTCUtils() {
        this.mParams  = MainNetParams.get();
    }

    public WBTCUtils(String seed) {
        try {
    ...
    public List<ChildNumber> getParentPath() {
        return  ImmutableList.of(new ChildNumber(44, true), ChildNumber.ZERO_HARDENED, ChildNumber.ZERO_HARDENED, ChildNumber.ZERO);
    }
    ...
    public String getPublicKeyAsHex(DeterministicKey key) {
