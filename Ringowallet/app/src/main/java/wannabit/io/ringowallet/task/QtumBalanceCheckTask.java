...
public class QtumBalanceCheckTask extends AsyncTask<String, Void, TaskResult> {
    ...
    public QtumBalanceCheckTask(BaseApplication app, TaskCallback mCallback, WalletItem walletItem, int position) {
        this.mApp = app;
