...
public class BtcBalanceCheckTask extends AsyncTask<String, Void, TaskResult> {
    ...
    public BtcBalanceCheckTask(BaseApplication app, TaskCallback mCallback, WalletItem walletItem, int position) {
        this.mApp = app;
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            WLog.w("BtcBalanceCheckTask : "  + e.getMessage());
